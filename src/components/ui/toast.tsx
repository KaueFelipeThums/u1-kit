        ...
        {toasts.map((toast) => (
          <Toast.Root
            ...
            className={cn(
              ...
              toast.type === 'success' && 'bg-success border-success-border text-success-foreground',
              toast.type === 'error' && 'bg-danger border-danger-border text-danger-foreground',
              toast.type === 'info' && 'bg-info border-info-border text-info-foreground',
              toast.type === 'warning' && 'bg-warning border-warning-border text-warning-foreground',
            )}
            style={{
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                <Toast.Title className="text-[13px] leading-relaxed font-medium" data-slot="toast-title" />
                <Toast.Description className="text-[13px] leading-normal" data-slot="toast-description" />
              </div>
            </div>
            {toast.actionProps && (
              <Toast.Action
                className={cn(buttonVariants({ size: 'sm' }), 'h-6 px-2 text-xs font-medium')}
