...
function ContextMenuPositioner({ ...props }: React.ComponentProps<typeof BaseContextMenu.Positioner>) {
  return <BaseContextMenu.Positioner data-slot="context-menu-positioner" {...props} />;
}

function ContextMenuRadioGroup({ ...props }: React.ComponentProps<typeof BaseContextMenu.RadioGroup>) {
...
function ContextMenuContent({
  ...
  return (
    <ContextMenuPortal>
      <ContextMenuPositioner className="z-50 outline-none select-none" align={align} sideOffset={sideOffset}>
        <BaseContextMenu.Popup
          data-slot="context-menu-content"
          className={cn(
            'bg-popover overflow-auto max-h-[var(--available-height)] data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0',
            'data-closed:zoom-out-95 text-popover-foreground data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2',
            'data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 min-w-[12rem] origin-[var(--transform-origin)]',
...
function ContextMenuRadioItem({
  ...
  return (
    <BaseContextMenu.RadioItem
      ...
      className={cn(
        'focus:bg-accent focus:text-accent-foreground relative flex cursor-default items-center gap-2 rounded-sm py-1.5 pr-2',
        'pl-8 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none',
...
function ContextMenuSub({ ...props }: React.ComponentProps<typeof BaseContextMenu.SubmenuRoot>) {
  return <BaseContextMenu.SubmenuRoot delay={0} closeDelay={0} data-slot="context-menu-sub" {...props} />;
}
...
function ContextMenuSubContent({
  ...
  return (
    <ContextMenuPortal>
      <ContextMenuPositioner className="z-50 outline-none select-none" sideOffset={sideOffset} align={align}>
        <BaseContextMenu.Popup
          data-slot="context-menu-sub-content"
          className={cn(
            'bg-popover overflow-auto max-h-[var(--available-height)] text-popover-foreground data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out',
            'data-closed:fade-out-0 data-closed:zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2',
            'data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 min-w-[12rem] origin-[var(--transform-origin)]',
