...
function Slider({
  ...
  return (
    <BaseSlider.Root
      ...
      {...props}
    >
      <BaseSlider.Control data-slot="slider-control" className="flex w-full items-center">
        <BaseSlider.Track
...
function SliderValue({ className, ...props }: React.ComponentProps<typeof BaseSlider.Value>) {
  return (
    <BaseSlider.Value
