...
function NavigationMenu({ className, children, ...props }: React.ComponentProps<typeof BaseNavigationMenu.Root>) {
  return (
    <BaseNavigationMenu.Root data-slot="navigation-menu" className={cn('min-w-max', className)} {...props}>
      {children}
  ...
  return (
    <BaseNavigationMenu.Portal data-slot="navigation-menu-portal">
      <BaseNavigationMenu.Positioner
        sideOffset={4}
        align="start"
        className="h-[var(--positioner-height)] w-[var(--positioner-width)] max-w-[var(--available-width)] origin-[var(--transform-origin)] duration-300 z-50"
