...
function DropdownMenuContent({
  ...
  return (
    <DropdownMenuPortal>
      <DropdownMenuPositioner className="z-50 outline-none select-none" sideOffset={sideOffset} align={align}>
        <BaseMenu.Popup
          data-slot="dropdown-menu-content"
          className={cn(
            'bg-popover overflow-auto max-h-[var(--available-height)] data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out',
            'data-closed:fade-out-0 data-closed:zoom-out-95 text-popover-foreground data-[side=bottom]:slide-in-from-top-2',
            'data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 min-w-[12rem]',
            'origin-[var(--transform-origin)] rounded-md border p-1 shadow-md',
            className,
          )}
          {...props}
        />
    ...
    <DropdownMenuPortal>
      <DropdownMenuPositioner className="z-50 outline-none select-none" sideOffset={sideOffset} align={align}>
        <BaseMenu.Popup
          data-slot="dropdown-menu-content"
          className={cn(
            'bg-popover overflow-auto max-h-[var(--available-height)] h-full text-popover-foreground data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out',
